...
const CarouselContainer = () => {
  ...
  const handlePrev = () => {
    if (isHovering) {
      setDirection(null); // Reset direction if hovering
    } else {
      setDirection("left"); // Set direction to "right" to slide in from the right
      setTimeout(() => {
        setDirection(null);
  ...
  const handleNext = () => {
    if (isHovering) {
      ...
      setDirection("right"); // Set direction to "left" to slide in from the left
      setTimeout(() => {
        setDirection(null);
      }, 500); // Adjust the timeout to match the duration of your animation
    }
