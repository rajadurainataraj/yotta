  ...
  return (
    ...
    >
      ...
      <div className=" d-flex  flex-column justify-content-center align-items-center ">
        <h4 className="h4 text-light mont text-center mont mb-3 mt-3 ">
        ...
        <p className="p lato text-center lato custom-contact-div">
          ...
          complex data driven web application development,<br></br> an ecommerce
          website, a native or cross platform mobile app development, a logo and
          brand identity design, a video <br></br> production or a full fledged
