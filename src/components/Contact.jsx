        ...
        <Form className="container-fluid d-flex custom-contact justify-content-evenly">
          <section>
            ...
            <div className="d-flex gap-3  align-items-center py-3">
              ...
              <h3 className="display-6">Telephone</h3>
            </div>
            ...
            <div className="d-flex gap-3 align-items-center py-3">
              ...
              <h3 className="display-6">Instagram</h3>
            </div>
            ...
            <div className="d-flex gap-3  align-items-center py-3">
              ...
              <h3 className="display-6">Locate Us</h3>
            </div>
          ...
          <section className="d-flex flex-column gap-5 form-group py-4">
            ...
            <div className="d-flex flex-column  gap-3">
              <Field
                ...
                className="form-control py-3 text-area-contact"
              />
              <ErrorMessage
                name="message"
                component="div"
